...
<script type="text/javascript">
     ...
     function DisplStep3() {
      ...
      out = out + "<div class='row'><div class='col-sm-12'><img class='img-responsive' src='" + rcmAvailableCars[0]["imageurl"] + "' alt='' class='car-img' /></div></div>";
                    ...
                    <div id="databeforecheck">
                      ...
                      <div class="row">
                            ...
                            <div class="col-sm-4"><label class="control-label"><strong>Your DOB :</strong></label></div>
														<div class="col-sm-8"><span class="caldispl"><input type="hidden" id="chkDBO" value=""></span></div>
                            </div>
                            <div class="col-sm-5">
